...
$(document).ready(function() {
	...
	function selectModel() {
        ...
        document.getElementById('navCoke').classList.add("active");
		...
		$('#navSprite').click(function(){
	       ...
	       var links = document.getElementsByClassName("nav-link");
	        for (var i = 0; i < links.length; i++) {
			    ...
			    document.getElementById('navSprite').classList.add("active");
		...
		$('#navPepper').click(function(){
	       ...
	       var links = document.getElementsByClassName("nav-link");
	        for (var i = 0; i < links.length; i++) {
			    ...
			    document.getElementById('navPepper').classList.add("active");
